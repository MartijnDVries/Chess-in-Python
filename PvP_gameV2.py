...
class APP:
    def timer():
        ...
        global black_score
        global white_score
        Pieces_PvP.draw = False
        Pieces_PvP.stale_mate = False
        Pieces_PvP.fifty_move_draw = False
        Pieces_PvP.white_checkmate = False
        Pieces_PvP.black_checkmate = False
        Pieces_PvP.instant_draw = False
        ...
        global white_turn
        global black_turn
        if int(Pieces_PvP.turn) % 2 == 0:
            white_turn = True
        elif int(Pieces_PvP.turn) % 2 == 1:
            white_turn = False
        ...
        while timer_run_always:
            while timer_run:
                while not white_turn:
                    ...
                    if timer_seconds2 == 0:
                        black_time_out = True
                        if not Pieces_PvP.white_draw_TO:
                            white_score += 1
                        if Pieces_PvP.white_draw_TO:
                            white_score += 0.5
                            black_score += 0.5
                        timer_run = False
                        break
                    if int(Pieces_PvP.turn) % 2 == 0:
                        timer_seconds2 += int(increment)
                        secs2 += int(increment)
                        if secs2 > 59:
                            mins2 += 1
                            secs2 = int(secs2) - 60
                        ...
                        white_turn = True
                    if Pieces_PvP.draw \
                            or Pieces_PvP.stale_mate \
                            or Pieces_PvP.fifty_move_draw \
                            or Pieces_PvP.instant_draw:
                        black_score += 0.5
                        white_score += 0.5
                        white_turn = False
                        timer_run = False
                        break
                    if Pieces_PvP.black_checkmate \
                            or resign_white_win:
                        resign_white_win = False
                        resign_black_win = False
                        white_score += 1
                ...
                while white_turn:
                    ...
                    if timer_seconds == 0:
                        white_time_out = True
                        if not Pieces_PvP.black_draw_TO:
                            black_score +=1
                        if Pieces_PvP.black_draw_TO:
                            black_score += 0.5
                            white_score += 0.5
                        timer_run = False
                        break
                    if int(Pieces_PvP.turn) % 2 == 1:
                        timer_seconds += int(increment)
                        secs += int(increment)
                        if secs > 59:
                            mins += 1
                            secs = int(secs) - 60
    ...
    def main():
        ...
        if Pieces_PvP.turn % 2 == 0:
            play_color = "white"
        elif Pieces_PvP.turn % 2 == 1:
            play_color = "black"
        ...
        while run:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    for piece in Pieces_PvP.white_pieces_list:
                        if piece.rect.collidepoint(pos):
                            piece.active = True
                    for piece in Pieces_PvP.black_pieces_list:
                        if piece.rect.collidepoint(pos):
                            piece.active = True
                    ...
                    if Pieces_PvP.draw \
                            or Pieces_PvP.stale_mate \
                            or Pieces_PvP.fifty_move_draw \
                            or Pieces_PvP.black_checkmate \
                            or Pieces_PvP.white_checkmate \
                            or resign_pop_up \
                            or white_time_out \
                            or black_time_out \
                            or Pieces_PvP.instant_draw:
                    ...
                    if main_menu_btn_2.rect.collidepoint(pos) \
                            and not quit_pop_up \
                            and not draw_pop_up \
                            and not Pieces_PvP.draw \
                            and not Pieces_PvP.stale_mate \
                            and not Pieces_PvP.fifty_move_draw \
                            and not Pieces_PvP.black_checkmate \
                            and not Pieces_PvP.white_checkmate \
                            and not resign_pop_up \
                            and not white_time_out \
                            and not black_time_out \
                            and not Pieces_PvP.instant_draw:
                        pygame.quit()
                        with open("main_menu2.py") as f:
                            code = f.read()
                            exec(code)
            ...
            if Pieces_PvP.white_king_check \
                    and not Pieces_PvP.white_checkmate \
                    and not Pieces_PvP.black_checkmate \
                    or Pieces_PvP.black_king_check \
                    and not Pieces_PvP.white_checkmate \
                    and not Pieces_PvP.black_checkmate:
            ...
            if int(Pieces_PvP.turn) % 2 == 0:
                Pieces_PvP.black_pieces_list.draw(screen)
                Pieces_PvP.white_pieces_list.draw(screen)
            elif int(Pieces_PvP.turn) % 2 == 1:
                Pieces_PvP.white_pieces_list.draw(screen)
                Pieces_PvP.black_pieces_list.draw(screen)
            ...
            if Pieces_PvP.draw:
                ...
                draw_by_agreement = False
            if Pieces_PvP.stale_mate:
                timer_run =  False
                draw_kader.draw_button(screen)
                stale_mate_text.draw_text(screen)
                play_again_btn.draw_button(screen)
                main_menu_btn.draw_button(screen)
            if Pieces_PvP.fifty_move_draw:
                timer_run =  False
                draw_kader.draw_button(screen)
